...
def split_and_preprocess_trainingdata (training_data, pathtomodel):
	...
	pickle.dump(ss, open(pathtomodel+'scaler_knn.pkl', 'wb'))
...
def train_knn(x_train, y_train, pathtomodel, maxK, seed):
	...
	# Save model
	pickle.dump(knn, open(pathtomodel+'model_knn.pkl', 'wb'))
...
if __name__ == "__main__":	
    ...
    knn = train_knn(x_train, y_train, pathtomodel, maxK, seed)
